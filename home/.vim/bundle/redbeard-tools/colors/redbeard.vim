...
hi MoreMsg		  term=bold  cterm=bold  ctermfg=85 gui=bold  guifg=SeaGreen
"hi ModeMsg		  term=bold  cterm=bold  gui=bold  guifg=White	guibg=Blue
hi ModeMsg		  term=bold  cterm=bold  gui=bold ctermfg=white	 ctermbg=blue guifg=White	guibg=Blue
...
hi Comment		  term=bold  ctermfg=111  guifg=#80a0ff
"hi Constant		  term=underline  cterm=bold ctermfg=white  guifg=#ffa0a0
hi Constant		  term=underline  ctermfg=217  guifg=#ffa0a0
"hi Special		  term=bold  cterm=bold ctermfg=red  guifg=Orange
""hi Special		  term=bold  cterm=bold ctermfg=130  guifg=Orange
""hi Special		  term=bold  ctermfg=208  guifg=Orange
hi Special		  term=bold  ctermfg=172  guifg=Orange
"hi Identifier	  term=underline   ctermfg=brown  guifg=#40ffff
""" TODO: Fix this
""hi Identifier	  term=underline   ctermfg=251  guifg=#40ffff
hi Identifier	  term=underline cterm=NONE  ctermfg=white  guifg=#40ffff
hi Statement	  term=bold  cterm=bold ctermfg=yellow	gui=bold  guifg=#ffff60
""hi PreProc		  term=underline  ctermfg=darkmagenta   guifg=#ff80ff
hi PreProc		  term=underline  ctermfg=207   guifg=#ff80ff
""hi Type			  term=underline  cterm=bold ctermfg=lightgreen  gui=bold  guifg=#60ff60
hi Type			  term=underline  cterm=bold ctermfg=83  gui=bold  guifg=#60ff60
""hi Error		  term=reverse	ctermfg=darkcyan  ctermbg=black  guifg=Red	guibg=Black
hi Error		  term=reverse	ctermfg=red  ctermbg=black  guifg=Red	guibg=Black
